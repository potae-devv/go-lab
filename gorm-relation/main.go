...
func main() {
	...
	bookWithAuthors, err := getBookWithAuthors(db, 2)
	fmt.Println("========================")
	fmt.Printf("Book Details:\n"+
		...
		"  Publisher Details: %s\n",
		bookWithAuthors.ID,
		bookWithAuthors.Name,
		bookWithAuthors.Author,
		bookWithAuthors.Description,
		bookWithAuthors.PublisherID,
		bookWithAuthors.Publisher.Name,
		bookWithAuthors.Publisher.Details)

	fmt.Println("Authors:")
	for i, author := range bookWithAuthors.Authors {
		fmt.Printf("  Author #%d:\n"+
			"    ID: %d\n"+
			"    Name: %s\n",
			i+1,
